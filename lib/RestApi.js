        ...
        web_socket.connect(params, callbacks)
          .then(() => {            
                ...
                web_socket.on('error', (error) => {
                  ...
                  // For example, you might want to close the connection or log the error
                });
          
                // Event listener for WebSocket closures
                web_socket.on('close', (event) => {
                  console.log('WebSocket connection closed:', event);
          
                  // Handle the closure as needed
                  // For example, you might want to attempt reconnection or log the closure event
                });
            })
            .catch((error) => {
