...
var NorenRestApi = function(params) {
  ...
  function post_request(route, params, usertoken = "") {
    ...
    self.loadOAuthTokenFile = function (tokenPath) {
        ...
        const tokenUserId = tokenData.USERID || tokenData.uid || tokenData.usrid || tokenData.user_id;
        const tokenAccountId = tokenData.actid || tokenData.Account_ID || tokenData.account_id || tokenUserId;

        self.__susertoken = tokenData.susertoken || tokenData.access_token || self.__susertoken;
        ...
        token_data
            .then(response => {
                ...
                if (data.access_token) {
                    ...
                    const tokenUserId = data.USERID || data.uid || data.usrid || data.user_id || params.uid;
                    const tokenAccountId = data.actid || data.Account_ID || data.account_id || tokenUserId;
