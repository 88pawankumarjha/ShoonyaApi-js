...
var NorenRestApi = function(params) {
  ...
  function post_request(route, params, usertoken = "") {
    ...
    self.loadOAuthTokenFile = function (tokenPath) {
        ...
        self.__susertoken = tokenData.susertoken || self.__susertoken;
        self.injectOAuthHeader(tokenData.access_token, tokenData.USERID, tokenData.actid);
        return tokenData;
    };
        ...
        token_data
            .then(response => {
                ...
                if (data.access_token) {
                    ...
                    self.injectOAuthHeader(data.access_token, data.USERID || params.uid, data.actid || params.uid);
                }
            }).catch(function (err) {
                throw err
            });
