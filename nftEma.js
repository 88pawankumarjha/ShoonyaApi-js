...
// getPickedIndexHere = () => debug ? 'NIFTY' : ['NIFTY', 'BANKEX', 'FINNIFTY', 'NIFTY', 'NIFTY', 'SENSEX', 'BANKEX'][new Date().getDay()] || 'NIFTY';
getPickedIndexHere = () => debug ? 'NIFTY' : ['NIFTY', 'NIFTY', 'NIFTY', 'NIFTY', 'NIFTY', 'NIFTY', 'NIFTY'][new Date().getDay()] || 'NIFTY';
let telegramSignals = {
  stopSignal: false,
  exitSignal: false,
  slower: false,
